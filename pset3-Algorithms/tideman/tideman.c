...
void record_preferences(int ranks[])
{
    // Avalia a classificação dos eleitores
    for (int i = 0; i < candidate_count; i++)
    {
        // Este loop deve começar de i + 1, pois só adicionamos ao array de preferências quando j vier depois de i no array de ranks;
        for (int j = i + 1; j < candidate_count; j++)
        {
            // Atualiza o número de eleitores quem prefere [i] a [j]no array de ranks -> Ex: [0, 3, 2, 1, 4]
