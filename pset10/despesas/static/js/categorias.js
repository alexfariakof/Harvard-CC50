var handleSaveCategoria = function(id) {       
    var _tipoCategoria = $('#tipoCategoria').val();
    var _descricao = $('#descricao').val();
    

    if ( typeof id === "undefined" || id === 0 || id === null || id === '')  {
        if (_tipoCategoria === '0' || typeof _tipoCategoria == "undefined" || _tipoCategoria === '' ){
            
            alertError('O campo tipo de categoria deve ser selecionado!');
            return false;
            
        }
        else if (typeof _descricao == "undefined" || _descricao === 0 || _descricao === null || _descricao === ''  == ' || '){
            ...
            $.ajax({
                ...
                beforeSend : function(){
                    //Colocar Vidro de loadong na tela                     
                },
                complete: function (jqxhr, txt_status) {
                    //if (txt_status === 'success' && jqxhr.status === 200)                  
                      // remover vidro com loading   
                },
                 success: function () {
